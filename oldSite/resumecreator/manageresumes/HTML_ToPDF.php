...
/*
  [February 15, 2005]
	This file was modified since the environmental PATH variable does not
	include the '/usr/local/bin/' path which is where the 'ps2pdf' programs
	are located. Because of this, the where the 'ps2pdf' command was to be 
	called is now replace with a call directly to 'gs' (ghostscript) itself.
	
	Other than that small change this file is exactly the same as it was when
	I downloaded it from: http://www.rustyparts.com/pdf.php in January 2005.


	-- Sean P. Jensen (Sean.Jensen@gmail.com)
...
//    var $html2psPath = '/usr/local/bin/html2ps';
    var $html2psPath = '/nfs/rack/u4/j/jensense/bin/html2ps/bin/html2ps';
...
*/
        ...
        $cmd = "/usr/local/bin/gs -dSAFER -dCompatibilityLevel=1.2 -sPAPERSIZE=letter -I -dAutoFilterColorImages=false -dColorImageFilter=/FlateEncode -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite \"-sOutputFile=".escapeshellcmd($this->pdfFile)."\" -dSAFER -dCompatibilityLevel=1.2 -sPAPERSIZE=letter -I -dAutoFilterColorImages=false -dColorImageFilter=/FlateEncode -c .setpdfwrite -f \"$a_tmpFiles[ps]\" ";
