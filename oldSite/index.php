<?php
echo "HELLLOOOOOOO DEREEEEE";
echo "This password is password";
/*
    PmWiki
...
$AuthDeniedFmt = 'The password is acm. Username is nonspecific.'; //'$[A valid password is required to access this feature.]';
